...
This experiment demonstrates that conditioning PE generation on DP-noised aggregates can meaningfully improve utility for queries that align with the stratification, while maintaining formal privacy guarantees through proper composition. The approach is complementary to the hybrid routing strategy: combining stratified PE with workload routing could further improve the overall benchmark.
